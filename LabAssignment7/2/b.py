...
def key_callback(window, key, scancode, action, mods):
    ...
    if action==glfw.PRESS or action==glfw.REPEAT:
        if key==glfw.KEY_1:
            ...
            objectColor = (1.-objectColor[0],objectColor[1],objectColor[2],objectColor[3])
        elif key==glfw.KEY_G:
            objectColor = (objectColor[0],1.-objectColor[1],objectColor[2],objectColor[3])
        elif key==glfw.KEY_B:
            objectColor = (objectColor[0],objectColor[1],1.-objectColor[2],objectColor[3])
